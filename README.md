...
- **Tile სერვერები:** OSM/OpenTopoMap-ის საჯარო სერვერები მხოლოდ development-ისთვის — production-მდე გადასაწყვეტია საკუთარი proxy ან MapTiler free tier.
- **Open-Meteo commercial ლიცენზია** — monetization-ის გადაწყვეტისას გადასამოწმებელი.
