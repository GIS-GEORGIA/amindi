...
| **Phase 3** | ლოკალიზაცია ka/en + light/dark თემა + პარამეტრების ეკრანი | ✅ |
| **Phase 4** | მოდელების აღწერის ეკრანი | ✅ |
| **Phase 5** | Overlay: ტემპერატურა + ნალექი (grid + საკუთარი რენდერი, ICON-EU), დროის სლაიდერი | ✅ |
| **Phase 5+** | ქარის ანიმაცია/ისრები overlay-ზე | ⏳ |
